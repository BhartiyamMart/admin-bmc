      ...
      try {
        ...
        if (!response.error && response.payload) {
          ...
          setForm({
            ...
            validFrom: parseDate(coupon.validFrom) || new Date(),
            validUntil: parseDate(coupon.validUntil),
              ...
              <div className="flex flex-col gap-1">
                ...
                <Popover open={openPopovers.status} onOpenChange={(isOpen) => togglePopover('status', isOpen)}>
                  <PopoverTrigger asChild>
                    <Button
                      variant="outline"
                      className="w-full cursor-pointer justify-between px-3 py-1.25 font-normal"
                    >
