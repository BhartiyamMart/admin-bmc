...
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components/ui/table';
import * as Icon from 'lucide-react';
import { viewCustomerDetails } from '@/apis/create-customer.api'; // Update with your actual path
              ...
              <div className="flex-1 space-y-4">
                <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                  <div>
                    ...
                    <p className="text-foreground">{customer.email || customer.phone}</p>
                  </div>
                  <div className="flex gap-2">
                    <Badge className={getStatusColor(customer.status)}>
                      <Icon.Circle className="mr-1 h-2 w-2 fill-current" />
                ...
                <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
                  <div className="bg-sidebar rounded-lg border p-3">
                    <div className="flex items-center gap-2">
                      <Icon.Wallet className="h-4 w-4 text-green-600" />
                      <span className="text-foreground text-sm font-medium">Wallet</span>
                    </div>
                    <p className="text-foreground text-lg font-semibold">
                      ₹{customer.wallet ? customer.wallet.toLocaleString() : '0'}
                    </p>
                  </div>
                  <div className="bg-sidebar rounded-lg border p-3">
                    <div className="flex items-center gap-2">
                      <Icon.TrendingUp className="h-4 w-4 text-blue-600" />
                      <span className="text-foreground text-sm font-medium">Total Spent</span>
                    </div>
                    <p className="text-foreground text-lg font-semibold">
                      ₹{parseFloat(customer.spent || '0').toLocaleString()}
                    </p>
                  </div>
                  <div className="bg-sidebar rounded-lg border p-3">
                    <div className="flex items-center gap-2">
                      <Icon.ShoppingBag className="h-4 w-4 text-purple-600" />
                      <span className="text-foreground text-sm font-medium">Total Orders</span>
                    </div>
                    <p className="text-foreground text-lg font-semibold">{customer.orders.length}</p>
                  </div>
                  <div className="bg-sidebar rounded-lg border p-3">
                    <div className="flex items-center gap-2">
                      <Icon.Gift className="h-4 w-4 text-orange-600" />
                      <span className="text-foreground text-sm font-medium">Reward Coins</span>
                    </div>
                    <p className="text-foreground text-lg font-semibold">{customer.rewardCoins}</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid gap-3">
                    <div className="flex justify-between">
                      ...
                      <span className="text-foreground font-mono text-sm text-xs">#{customer.id.slice(0, 8)}...</span>
                    </div>
                    <Separator />
                    <div className="flex justify-between">
              ...
              <CardContent>
                {customer.orders.length > 0 ? (
                  ...
                  <div className="py-8 text-center">
                    <Icon.ShoppingBag className="text-foreground mx-auto mb-4 h-12 w-12 opacity-50" />
                    <p className="text-foreground text-sm">No orders found</p>
                  </div>
                )}
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-foreground text-xs">{customer.lastLogin}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="rounded-full bg-green-100 p-2">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-foreground text-xs">{customer.createdAt}</p>
                    </div>
                  </div>
                  {customer.referrals > 0 && (
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-foreground text-xs">Total referrals</p>
                      </div>
                    </div>
                  )}
                </div>
